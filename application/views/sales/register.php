    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Seleccionar asientos</h4>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6" id="asientos-panel">
                    <div class="form-group">
                        <label for="date-show">Día</label>
                        <input type="text" id="date-show" name="date_show" class="form-control" value="<?php echo date('Y-m-d') ?>">
                    </div>
                    <div class="form-group">
    ...
    <div class="panel-body form-group">
        <ul>
            ...
            if ($this->Employee->has_grant('reports_sales', $this->session->userdata('person_id'))) {
                ?>
                <li class="pull-right">						
                    <?php echo anchor($controller_name . "/manage", '<span class="glyphicon glyphicon-list-alt">&nbsp</span>' . $this->lang->line('sales_takings'), array('class' => 'btn btn-primary btn-sm', 'id' => 'sales_takings_button', 'title' => $this->lang->line('sales_takings')));
                    ?>
                </li>
                <?php
            }
